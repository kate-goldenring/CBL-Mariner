...
Source0:        https://cpan.metacpan.org/authors/id/G/GB/GBARR/CPAN-DistnameInfo-%{version}.tar.gz#/perl-CPAN-DistnameInfo-%{version}.tar.gz
BuildArch:      noarch
BuildRequires:  make
...
%changelog
* Fri Oct 15 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 0.12-19
