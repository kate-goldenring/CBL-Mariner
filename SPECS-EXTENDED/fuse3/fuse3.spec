...
%changelog
* Mon Jun 14 2021 Thomas Crain <thcrain@microsoft.com> - 3.9.1-2
- Initial CBL-Mariner import from Fedora 32 (license: MIT).
- Simplify spec by removing RHEL-specific parts
- Add build-time dependency on systemd-devel for udev pkgconfig files
