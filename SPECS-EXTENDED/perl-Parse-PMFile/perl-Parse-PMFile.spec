...
# Run optional test
%bcond_with perl_Parse_PMFile_enables_optional_test
...
Source0:        https://cpan.metacpan.org/authors/id/I/IS/ISHIGAKI/Parse-PMFile-%{version}.tar.gz#/perl-Parse-PMFile-%{version}.tar.gz
