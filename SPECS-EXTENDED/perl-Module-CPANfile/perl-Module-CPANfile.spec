...
Source0:        https://cpan.metacpan.org/authors/id/M/MI/MIYAGAWA/Module-CPANfile-%{version}.tar.gz#/perl-Module-CPANfile-%{version}.tar.gz
BuildArch:      noarch
BuildRequires:  make
...
%changelog
* Fri Oct 15 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 1.1004-8
